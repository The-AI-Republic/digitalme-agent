...
Creators define their agent's personality, knowledge, and boundaries in a simple YAML config — no AI expertise required.
...
- **Configurable personality** — name, tone, boundaries, and knowledge via YAML
...
2. Configure your agent:
   ...
   soul:
     ...
     boundaries: "Don't give medical or legal advice."
